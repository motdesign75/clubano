...
<div class="max-w-xl mx-auto space-y-6 text-gray-800">
    <h1 class="text-2xl font-bold">✏️ Tag bearbeiten</h1>
    ...
    <form method="POST" action="{{ route('tags.update', $tag) }}" class="space-y-4">
        ...
        <div>
            ...
            <input type="color" name="color" id="color" value="{{ old('color', $tag->color ?? '#4f46e5') }}"
                   class="w-16 h-10 mt-1 rounded border-gray-300 shadow-sm">
        </div>

        <div class="text-right space-x-2">
            <a href="{{ route('tags.index') }}" class="text-gray-600 hover:underline">Zurück</a>
