...
<head>
    ...
    <style>
        ...
        .body table { width: 100%; border-collapse: collapse; margin: 5.5mm 0; }
        .body th, .body td { border: 0.25mm solid #cbd5e1; padding: 4mm 5mm; vertical-align: top; font-size: 13.5pt; line-height: 1.3; }
        .body th { background: #f8fafc; font-weight: bold; color: #0f172a; }
        .body td { color: #172033; }
        .body table:not([role="presentation"]) td { font-weight: 700; }
